...
<head>
    ...
    <title>Paramètres - PetsCape</title>
...
<main class="max-w-4xl mx-auto px-6 py-8">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-[#2F2E41]">Paramètres</h1>
        <p class="text-gray-600 mt-1">Configurez votre compte et vos préférences</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
            <div class="bg-white p-8 rounded-2xl shadow-sm">
                <h2 class="text-2xl font-bold text-[#2F2E41] mb-6">Bienvenue dans vos paramètres</h2>
                
                <p class="text-gray-600 mb-6">
                    Utilisez le menu de gauche pour naviguer entre les différentes sections de paramètres.
                </p>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-[#FFF5F5] p-6 rounded-xl">
                        <div class="flex items-center mb-4">
                            <svg class="w-8 h-8 text-[#FF6B6B]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                            </svg>
                            <h3 class="text-lg font-bold text-[#2F2E41] ml-3">Profil</h3>
                        </div>
                        <p class="text-gray-600 mb-4">
                            Mettez à jour vos informations personnelles, comme votre nom, email et numéro de téléphone.
                        </p>
                        <a href="{{ route('settings.profile') }}" class="text-[#FF6B6B] hover:text-[#FF8787] font-semibold">
                            Modifier le profil →
                        </a>
                    </div>
                    ...
                    <div class="bg-[#FFF5F5] p-6 rounded-xl">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-lg font-bold text-[#2F2E41] ml-3">Sécurité</h3>
                        </div>
                        <p class="text-gray-600 mb-4">
                            Modifiez votre mot de passe pour sécuriser votre compte.
                        </p>
                        <a href="{{ route('settings.password') }}" class="text-[#FF6B6B] hover:text-[#FF8787] font-semibold">
